...
This project is designed to help teams create, track, and manage internal product orders across different branches through a clean web interface.
...
- order list view
- status updates
- branch-based order highlighting and filtering
